...
if __name__ == "__main__":
    ...
    # Fix: Use index_col=0 to handle the Unnamed: 0 column if it exists in the CSV as an index
    try:
    ...
    input_data = [
        ...
        # Fix: Removed "quality" from input_data as it is the target, not an input feature
    ]
    ...
    input_example = {
        ...
        # Fix: Removed "quality" from input_example
    }
