...
if __name__ == "__main__":
    ...
    # Use runs:/ URI for robustness
    model_uri = "runs:/{}/sklear_mlflow_pyfunc".format(mlflow.active_run().info.run_id)

    # Note: validation_thresholds and baseline_model are not supported in MLflow 3.3.2
    # They have been removed from the evaluate call.
    mlflow.evaluate(
        model_uri,
        test,
        targets="quality",
