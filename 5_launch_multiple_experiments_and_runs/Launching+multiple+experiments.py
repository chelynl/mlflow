...
from sklearn.linear_model import ElasticNet, Ridge, Lasso # regression models
import mlflow
...
'''
This script demonstrates how to launch multiple experiments and runs using MLflow.
Each experiment tests different regression models (ElasticNet, Ridge, Lasso).
Each experiment contains three runs with varying hyperparameters.

You can create different functions/files for individual experiments and call them in main.py as needed.
This would prevent manual copy/paste and help modularize the code.
'''
...
if __name__ == "__main__":
    ...
    mlflow.set_tracking_uri(uri="/Users/chelynlee/Downloads/MLFlow_Udemy/5_launch_multiple_experiments_and_runs/mlruns")
